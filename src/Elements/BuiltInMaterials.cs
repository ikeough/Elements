...
namespace Elements
{
    ...
    public static class BuiltInMaterials
    {
        ...
        private static Material _points = new Material("points", new Color(1.0f, 1.0f, 0.0f, 1.0f), 0.0f, 0.0f, null, true, false, Guid.Parse("9f4c28e7-a140-4b4a-85f5-3551d468e921"));
        private static Material _topography = new Material("topography", new Color(0.59f, 0.59f, 0.39f, 1.0f), 0.0f, 0.0f, null, false, true, Guid.Parse("ab838896-b7ef-43a2-afac-f3294153b3db"));
